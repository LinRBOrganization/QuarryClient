...
namespace LB.Controls.LBTextBox
{
	...
	public class CoolTextBox : System.Windows.Forms.UserControl
	{
        ...
        {
           // this.autoCompleteTextBox1.Width = this.Width - this.lblTitle.Width-10;
        }
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			Rectangle rect = new Rectangle( this.autoCompleteTextBox1.Left,this.autoCompleteTextBox1.Top,
                this.autoCompleteTextBox1.Width, this.autoCompleteTextBox1.Height) ;
			rect.Width -= 1;
			rect.Height -= 1;
		...
		private void InitializeComponent()
		{
            ...
            this.autoCompleteTextBox1 = new LB.Controls.LBTextBox.AutoCompleteTextBox();
            this.SuspendLayout();
            // 
            // lblTitle
            // 
